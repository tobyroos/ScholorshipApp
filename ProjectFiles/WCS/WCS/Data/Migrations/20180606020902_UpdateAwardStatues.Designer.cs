...
namespace WCS.Data.Migrations
{
    ...
    [Migration("20180606020902_UpdateAwardStatues")]
    partial class UpdateAwardStatues
    {
            ...
            modelBuilder.Entity("WCS.Models.StudentForm", b =>
                {
                    b.HasOne("WCS.Models.AwardCycle", "AwardCycle")
                        .WithOne("StudentForm")
                        .HasForeignKey("WCS.Models.StudentForm", "AwardCycleId")
                        .OnDelete(DeleteBehavior.Cascade);
